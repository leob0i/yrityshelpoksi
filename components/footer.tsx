...
const footerLinks = {
  ...
  Resources: ["Community", "Help Center", "Status", "API"],
        ...
        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-r from-indigo-500/10 via-purple-500/10 to-indigo-500/10 p-12 text-center">
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-4 max-w-lg text-white/50">
              Join thousands of developers who ship UI in seconds with v0.
            </p>
            <Button 
              size="lg"
      ...
      <div className="mx-auto max-w-7xl px-6 pb-12">
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-white/5 pt-8 sm:flex-row">
          <p className="text-sm text-white/40">
            &copy; {new Date().getFullYear()} v0 by Vercel. All rights reserved.
          </p>
